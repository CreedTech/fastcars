# Generated by Django 4.0.6 on 2022-09-02 21:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand_name', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='service.brand')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('car', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.car')),
